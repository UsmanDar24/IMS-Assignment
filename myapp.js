...
function initPlayer() {
  ...
  player.configure('streaming.rebufferingGoal', 22.5);
  ...
  player.getNetworkingEngine().registerResponseFilter(function(type,response){
    ...
    console.log(stats.bufferingTime);
...
console.log(shaka.Stats);

//console.log(player.Stats.playTime());
//console.log(shaka.player.Stats.playTime())